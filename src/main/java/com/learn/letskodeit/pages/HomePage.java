...
public class HomePage extends Utility {
    ...
    public void clickOnLoginLink() {
        Reporter.addStepLog("Clicking on login button " + _loginLink.toString() + "<br>");
    ...
    public void clickOnPracticePage() {
        Reporter.addStepLog("Clicking on practice button " + _practiceLink.toString() + "<br>");
        clickOnElement(_practiceLink);
        log.info("Clicking on practice button " + _practiceLink.toString());
    }

    public void clickOnSignUpLink() {
        Reporter.addStepLog("Clicking on signUp button " + _signUpLink.toString() + "<br>");
