...
public class LoginPage extends Utility {
    ...
    public void enterEmailId(String email) {
        Reporter.addStepLog("Enter email field " +email+ "Email field"+ _emailField.toString() + "<br>");
        sendTextToElement(_emailField, email);
        log.info("Enter email field " +email+ "Email field" +_emailField.toString());
    }

    public void enterPassword(String password) {
        Reporter.addStepLog("Enter password field " +password+ "Password field"+ _passwordField.toString() + "<br>");
        sendTextToElement(_passwordField, password);
        log.info("Enter password field " +password+ "Password field"+ _passwordField.toString());
    }

    public void clickOnCommitFeature() {
        Reporter.addStepLog("Clicking on commit button " + _clickOnCommitButton.toString() + "<br>");
        clickOnElement(_clickOnCommitButton);
        log.info("Clicking on commit button " + _clickOnCommitButton.toString());
    }

    public String getLoginMessage() {
        Reporter.addStepLog("Getting login confirm message " + _getLoginText.toString() + "<br>");
    ...
    public String getAllCourseMessage() {
        Reporter.addStepLog("Getting all course text message " + _allCourseText.toString() + "<br>");
